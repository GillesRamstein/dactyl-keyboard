...
def update(config, _c):
    """Update dictionary if there are no key collisions"""
...
config = {
    ...
    "config_name": "test_print",
    "show_caps": False,  # False, "MX", "CHOC"
...
_c = {
    ...
    "plate_holes_diameter": 1.0,  # 1.6
    "plate_holes_depth": 4.0,  # 20.0
}
update(config, _c)
